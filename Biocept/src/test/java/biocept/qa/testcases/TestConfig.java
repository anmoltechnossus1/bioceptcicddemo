...
import biocept.qa.pages.NGSProfessionalInterpretation;
...
public class TestConfig extends BioceptBase{
	...
	NGSProfessionalInterpretation ngsProfessionalInterpretation;
	...
	public void setup() {
		...
		ngsProfessionalInterpretation= new NGSProfessionalInterpretation();
	}
	...
	@Test(priority= 3,dependsOnMethods = { "UploadMacroFile"}, description="Verify user is able to open the NGS Professional Interpretation Activity")
	public void NGS_PIActivityTitle() throws InterruptedException{
		test=extent.createTest("Verify user is able to open the NGS Professional Interpretation Activity", "User should be able to open NGS Professional Interpretation from my worklist.");
		test.assignCategory("NGS Workflow");
		ExplicitWait.invisibilityOfLoader();
		leftMenuItems.leftMenuSelection("Dashboards","My Worklist");
		myWorklist.search(AccessionID, "NGS");
		ExplicitWait.invisibilityOfLoader();
		String PageTitle = workflowCommonMethods.pageTitle();
		Assert.assertEquals(PageTitle, "NGS Professional Interpretation");
	}
	
	@Test(priority= 4,dependsOnMethods = { "NGS_PIActivityTitle"}, description="Verify user is able to upload the pdf file.")
	public void UploadNGSFile() throws InterruptedException{
		test=extent.createTest("Verify user is able to upload the pdf file.", "User should be able to upload the pdf file on NGS PI Activity.");
		test.assignCategory("NGS Workflow");
		ngsProfessionalInterpretation.uploadFile();
		ExplicitWait.invisibilityOfLoader();
		String FileUploadConfirmationMessage = workflowCommonMethods.completeMessage();
		ngsProfessionalInterpretation.clickOnSaveButon();
		ExplicitWait.invisibilityOfLoader();
		ngsProfessionalInterpretation.clickOnCompleteButon();
		ExplicitWait.invisibilityOfLoader();
		myWorklist.visibilityOfSearchTextBox();
		Assert.assertEquals(FileUploadConfirmationMessage, "File Uploaded Successfully");
	}	
	...
	@Test(priority= 5,dependsOnMethods = { "UploadNGSFile"}, description="Verify user is able to open the NRAS Molecular Generic Resulting Activity")
	public void NRASResultingActivityTitle() throws InterruptedException{
		...
		ExplicitWait.invisibilityOfLoader();
		leftMenuItems.leftMenuSelectionForExpendedItem("My Worklist");
	...
	@Test(priority= 6,dependsOnMethods = { "NRASResultingActivityTitle"}, description="Verify user is able to complete the NRAS Molecular Generic Resulting activity")
	...
	@Test(priority= 7, dependsOnMethods = { "NRASResultingUpdateResult"},description="Verify user is able to open NRAS Molecular Professional Interpretation activity")
...
//		ExplicitWait.invisibilityOfLoader();
	...
	@Test(priority= 8, dependsOnMethods = { "NRASPIActivityTitle"},description="Verify user is able to complete the NRAS Molecular Professional Interpretation activity")
	...
	@Test(priority= 9, dependsOnMethods = { "NRASPIActivityResult"}, description="Verify user is able to Signoff the NRAS Test Report from Molecular Review & Approve Worklist")
...
//		myWorklist.visibilityOfSearchTextBox();
	...
	@Test(priority= 10, dependsOnMethods = { "NRASReportSignoff"},description="Verify user is able to open the BRAF Molecular Generic Resulting Activity")
	...
	@Test(priority= 11,dependsOnMethods = { "BRAFResultingActivityTitle"}, description="Verify user is able to complete the BRAF Molecular Generic Resulting activity")
	...
	@Test(priority= 12, dependsOnMethods = { "BRAFResultingUpdateResult"}, description="Verify user is able to upload the Sequence image for BRAF")
	public void UploadSequenceImagesForBRAF() throws InterruptedException, IOException{
		test=extent.createTest("Verify user is able to upload the Sequence image for BRAF", "User should be able to upload the BRAF Sequence file from Sequence image section.");
		test.assignCategory("Molecular Workflow");
		ExplicitWait.invisibilityOfLoader();
		leftMenuItems.leftMenuSelection("Macros Molecular", "Upload Macro File");
		ExplicitWait.invisibilityOfLoader();
		...
		uploadMacroFile.fileProcessed(AccessionID, "B");
...
//		uploadMacroFile.reupdateSequencingImage();
	...
	@Test(priority= 13, dependsOnMethods = { "UploadSequenceImagesForBRAF"},description="Verify user is able to open BRAF Sequencing activity")
	...
	@Test(priority= 15, dependsOnMethods = { "BRAFSequencingActivityResult"},description="Verify user is able to open BRAF Molecular Professional Interpretation activity")
	public void BRAFPIActivityTitle() throws InterruptedException{
		...
		ExplicitWait.invisibilityOfLoader();
		String PageTitle = workflowCommonMethods.pageTitle();
		Assert.assertEquals(PageTitle, "Molecular Professional Interpretation");
		//String TestName = molecularProfessionalInterpretation.testName();
	}

	@Test(priority= 16,dependsOnMethods = { "BRAFPIActivityTitle"}, description="Verify user is able to complete the BRAF Molecular Professional Interpretation activity")
	...
	@Test(priority= 17, dependsOnMethods = { "BRAFPIActivityResult"}, description="Verify user is able to Signoff the BRAF Test Report from Molecular Review & Approve Worklist")
	...
	@Test(priority= 18, dependsOnMethods = { "BRAFReportSignoff"},description="Verify user is able to open the KRAS Molecular Generic Resulting activity")
	...
	@Test(priority= 19, dependsOnMethods = { "KRASResultingActivityTitle"},description="Verify user is able to complete the KRAS Molecular Generic Resulting activity")
	...
	@Test(priority= 20, dependsOnMethods = { "KRASResultingUpdateResult"}, description="Verify user is able to upload the Sequence imagefor KRAS")
	public void UploadSequenceImagesForKRAS() throws InterruptedException, IOException{
		test=extent.createTest("Verify user is able to upload the KRAS Sequence image", "User should be able to upload the KRAS Sequence file from Sequence image section.");
		test.assignCategory("Molecular Workflow");
		ExplicitWait.invisibilityOfLoader();
		leftMenuItems.leftMenuSelection("Macros Molecular", "Upload Macro File");
		ExplicitWait.invisibilityOfLoader();
		...
		uploadMacroFile.updateSequencingImage(AccessionID, "K");
		uploadMacroFile.uploadSequencingImage();
		uploadMacroFile.fileProcessed(AccessionID, "K");
		uploadMacroFile.reupdateSequencingImage();
...
////	}
	...
	@Test(priority= 19, dependsOnMethods = { "UploadSequenceImagesForKRAS"},description="Verify user is able to open KRAS Sequencing activity")
	...
	@Test(priority= 20, dependsOnMethods = { "KRASSequencingActivityTitle"},description="Verify user is able to complete the KRAS Sequencing activity")
	...
	@Test(priority= 21, dependsOnMethods = { "KRASSequencingActivityResult"},description="Verify user is able to open KRAS Molecular Professional Interpretation activity")
	...
	@Test(priority= 22,dependsOnMethods = { "KRASPIActivityTitle"}, description="Verify user is able to complete the KRAS Molecular Professional Interpretation activity")
	...
	@Test(priority= 23, dependsOnMethods = { "KRASPIActivityResult"}, description="Verify user is able to Signoff the KRAS Test Report from Molecular Review & Approve Worklist")
